    ...
    methods: {
        ...
        showDialog(row) {
            ...
            this.$nextTick(() => {
                this.form = {
                    ...row,
                    plateNumbers: (row.plateNumbers.slice(0, 1) + ',' + row.plateNumbers.slice(1, 2) + ',' + row.plateNumbers.slice(3)).split(','),
