<template>
    <div>
        <ul class="plan-list clear">
            ...
            <li v-for="lst in list" :key="lst.id" @click="videDetail(lst)">
                <div class="level">
            ...
            getList (pageIndex, rows, callback) {
                this.$securityApi.plan.currentPlanList({
                    ...
                    res.data.list.forEach(v => {
                        if (!v.currentPreDTO.securityIncident) {
                            v.currentPreDTO.securityIncident = {
                                urgencyName: ' '
                            }
                        }
                        if (!v.currentPreDTO.preLevel) {
                            v.currentPreDTO.preLevel = {}
                        }
                    })
